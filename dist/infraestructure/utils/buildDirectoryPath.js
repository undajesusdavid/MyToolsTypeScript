...
export async function normalizarRutaDelDirectorio(directoryFile) {
    ...
    try {
        ...
        if (error.code === "ERR_INVALID_URL") {
            console.error(`${prefijoDeError} la direccion proporcionada es invalida, no cumple con los parametros de la funcion fileURLToPath`, error);
        }
    }
}
